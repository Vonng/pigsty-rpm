...
#           https://github.com/supabase/pg_graphql/archive/refs/tags/v1.3.0.tar.gz
...
install -m 644 %{_sourcedir}/pg_graphql-pg%{pgmajorversion}/usr/pgsql-%{pgmajorversion}/share/extension/pg_graphql--1.3.0.sql %{buildroot}%{pginstdir}/share/extension/
