...
| ParadeDB      | [pg_search](https://github.com/paradedb/paradedb/tree/dev/pg_search)       | v0.6.1  | v0.11.3 | [AGPLv3](https://github.com/paradedb/paradedb/blob/dev/LICENSE)             | 16,15,14       |                      |
| ParadeDB      | [pg_analytics](https://github.com/paradedb/paradedb/tree/dev/pg_analytics) | v0.5.6  | v0.11.3 | [AGPLv3](https://github.com/paradedb/paradedb/blob/dev/LICENSE)             | 16,15,14       |                      |
| Supabase      | [pg_graphql](https://github.com/supabase/pg_graphql)                       | v1.5.4  | v0.11.3 | [Apache-2.0](https://github.com/supabase/pg_graphql/blob/master/LICENSE)    | 16,15,14       |                      |
...
| kelvich       | [pg_tiktoken](https://github.com/kelvich/pg_tiktoken)                      | v0.0.1  | v0.10.2 | https://github.com/kelvich/pg_tiktoken/blob/main/LICENSE                    | 16,15,14,13,12 |                      |
...
#cd ~/prometheus_fdw;           HTTPS_PROXY=http://192.168.0.104:8118 cargo pgrx package  -v;
